...
namespace ParkInc
{
    public class CurrenciesUIController : MonoBehaviour
    {
        ...
        public CurrencyUI GetCurrencyUI(Currency.Type type)
        {
        ...
        {
            Currency.Type type = currency.CurrencyType;
        ...
        public CurrencyUI ActivateCurrency(Currency.Type type, bool doNotHide = false)
        {
