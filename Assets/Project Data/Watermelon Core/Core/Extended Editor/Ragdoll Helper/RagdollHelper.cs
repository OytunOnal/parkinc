...
#pragma warning disable 649
    ...
    {
        public static void CreateRagdoll(Animator animator, float totalMass, float strength)
        {
#if UNITY_EDITOR
            if (animator == null)
            {
            ...
            RagdollCase ragdollCase = new RagdollCase(animator, totalMass, strength);
#endif
        }
        ...
        private class RagdollCase
        {
            ...
            public RagdollCase(Animator animator, float totalMass, float strength)
            {
