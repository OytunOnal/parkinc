...
using System;
using System.IO;
using static ParkInc.CustomField;
...
namespace ParkInc
{
    public class CustomList
    {
        ...
        public void ClearProperty(SerializedProperty property)
        {
        ...
        private void ClearValueProperty(SerializedProperty property)
        {
        ...
        public void MoveElement(int srcIndex,int destIndex)
        {
            ...
            else
            {
                if (usingPropertyList)
                {
                    ...
                    elementsList[srcIndex] = elementsList[destIndex];
                    elementsList[destIndex] = temp;
                }
                else
                {
        ...
        public void Display()
        {
            ...
            //log = "Event: " + currentEvent.type.ToString();
            ...
            //Debug.Log($"{log} dragging: {dragging} time: {tempTime} ");
        }
        ...
        private void UpdateDrag()
        {
            ...
            if(previousDraggedElementY != draggedElementY)
            {
                RequestRepaint();
            }
