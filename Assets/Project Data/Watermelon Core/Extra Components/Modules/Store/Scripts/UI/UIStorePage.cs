...
namespace ParkInc
{
    public class UIStorePage : UIPage
    {
        ...
        public override void Initialise()
        {
            ...
            coinsCurrency = CurrenciesController.GetCurrency(Currency.Type.Coins);
        }
        ...
        public override void PlayShowAnimation()
        {
            ...
            coinsCurrency.OnCurrencyChanged += OnCurrencyAmountChanged;

            coinsText.text = coinsCurrency.AmountFormatted;
            coinsPanelCurrencyImage.sprite = coinsCurrency.Icon;
        }
        ...
        public void InitStoreUI()
        {
            ...
            else
            {
                ...
                storePreview3D.Init();
                storePreview3D.SpawnPrefab(SelectedProductData.PreviewPrefab);
