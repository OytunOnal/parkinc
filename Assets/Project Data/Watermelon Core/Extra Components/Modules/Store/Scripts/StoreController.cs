...
namespace ParkInc
{
    public class StoreController : MonoBehaviour
    {
        ...
        [SerializeField] StoreDatabase database;
        private static StoreDatabase Database => instance.database;

        private static Dictionary<TabData, List<ProductData>> products;
        private static Dictionary<TabType, ProductData> selectedProducts;
        ...
        public static List<ProductData> GetProducts(TabData tab)
        {
            return products[tab];
        }
        ...
        public static ProductData GetSelectedProductData(TabType tabType)
        {
            return selectedProducts[tabType];
        }

        public static ProductData GetSelectedProductData(TabData tabData)
        {
            return selectedProducts[tabData.Type];
        }

        public static ProductData GetSelectedProductData(int tabId)
        {
            var tabData = Database.Tabs[tabId];
            return selectedProducts[tabData.Type];
        }

        public static GameObject GetSelectedPrefab(TabType type)
        {
        ...
        public static ProductData GetRandomLockedProduct()
        {
        ...
        public static ProductData GetRandomProduct(TabType tab)
        {
