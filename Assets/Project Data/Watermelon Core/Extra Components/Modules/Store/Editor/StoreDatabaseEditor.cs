...
namespace ParkInc
{
    ...
    public class StoreDatabaseEditor : WatermelonEditor
    {
        ...
        private void ProductAddElementCallback()
        {
            ...
            productList.ClearProperty(newPoductProp);
        ...
        private float GetHeightForPurchaseTypeAndCurrencyField(SerializedProperty elementProperty, CustomListStyle style)
        {
            ...
            if (purchaseTypyProperty.intValue == (int)ProductData.PurchaseType.InGameCurrency)
            {
        ...
        private void InitTabs()
        {
            if (tabsArrayProp.arraySize == 0)
            {
                ...
                tabsArrayProp.GetArrayElementAtIndex(0).stringValue = "Default";
            }
    ...
    {
        private static readonly string TAB_TYPE_SCRIPT_NAME = "TabType";
        private static readonly string PATH_SUFFICS = "\\TabType.cs";
        ...
        public TabTypePopupWindow()
        {
            ...
            typeNames = new List<string>(Enum.GetNames(typeof(TabType)));
        ...
        private void UpdateEnum()
        {
            ...
            stringBuilder.AppendLine();
            stringBuilder.Append("\tpublic enum TabType");
            stringBuilder.AppendLine();
            stringBuilder.Append("\t{");
            stringBuilder.AppendLine();
